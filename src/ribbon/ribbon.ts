    ...
    this.ribbonElement.innerHTML = `
        <div class="top">
          <div class="tablist-container leftSection">
            <div class="tablist-items">File</div>
        ...
        <div class="focus-zone">
          <div class="scroll-left btn" role="button" tabindex="0">
              ...
              <div class="tab-section section-1">
                ...
                <div class="feature-box box-1">
                  <div class="content divided-in-column">
                    <div class="col">
                      <div class="feature-vertical btn" role="button" tabindex="0" >
                    ...
                    <div class="col">
                      <div class="feature-horizontal btn" role="button" tabindex="0" >
                ...
                <div class="feature-box box-2">
                  <div class="content divided-in-row">
                    <div class="row">
                      ...
                      <div class="feature-icon" role="button" tabindex="0" >
          ...
          <!-- updated for not expandable below -->
                    <div class="scroll-right btn" role="button" tabindex="0">
            <div class="icon icon-down"></div>
          </div>
